    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <section className="py-24 px-6 bg-surface">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-serif text-white mb-8">O QUE É O MERCADO LIVRE DE ENERGIA?</h2>
      ...
      <section className="py-24 px-6 bg-background">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-serif text-white mb-16 text-center">BENEFÍCIOS POTENCIAIS</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-8 bg-surface border border-border-light">
              ...
              <h3 className="text-lg font-serif text-white mb-3">POSSIBILIDADE DE ECONOMIA</h3>
            ...
            <div className="p-8 bg-surface border border-border-light">
              ...
              <h3 className="text-lg font-serif text-white mb-3">PREVISIBILIDADE</h3>
            ...
            <div className="p-8 bg-surface border border-border-light">
              ...
              <h3 className="text-lg font-serif text-white mb-3">NEGOCIAÇÃO</h3>
            ...
            <div className="p-8 bg-surface border border-border-light">
              ...
              <h3 className="text-lg font-serif text-white mb-3">ESTRATÉGIA</h3>
      ...
      <section className="py-24 px-6 bg-surface border-y border-border-light">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-serif text-white mb-4">SUA EMPRESA PODE TER NOVAS POSSIBILIDADES.</h2>
            <p className="text-muted">Envie algumas informações da sua operação para uma avaliação inicial.</p>
          </div>
          
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <input type="text" className="w-full bg-background border border-border-light rounded-md px-4 py-3 text-white focus:outline-none focus:border-primary transition-colors" placeholder="Nome completo" />
              <input type="text" className="w-full bg-background border border-border-light rounded-md px-4 py-3 text-white focus:outline-none focus:border-primary transition-colors" placeholder="Empresa" />
              <input type="tel" className="w-full bg-background border border-border-light rounded-md px-4 py-3 text-white focus:outline-none focus:border-primary transition-colors" placeholder="WhatsApp" />
              <input type="email" className="w-full bg-background border border-border-light rounded-md px-4 py-3 text-white focus:outline-none focus:border-primary transition-colors" placeholder="E-mail" />
              <input type="text" className="w-full bg-background border border-border-light rounded-md px-4 py-3 text-white focus:outline-none focus:border-primary transition-colors" placeholder="Valor médio da conta de energia (R$)" />
              <input type="text" className="w-full bg-background border border-border-light rounded-md px-4 py-3 text-white focus:outline-none focus:border-primary transition-colors" placeholder="Segmento da empresa" />
            </div>
